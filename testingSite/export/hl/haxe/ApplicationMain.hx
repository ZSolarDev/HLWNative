...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TestingSite", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TestingSite", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TestingSite";
		app.meta["name"] = "TestingSite";
