...
class PlayState extends FlxState
{
	...
	override public function create()
	{
		...
		colorBarColorTxt.text = '
            Press D to open a directory!\n
            Last picked directory: \n
            Press F to open a file!\n
            Last picked file: \n
	...
	override public function update(elapsed:Float)
	{
		...
		colorBarColorTxt.text = '
            Press D to open a directory!\n
            Last picked directory: ${lpd}\n
            Press F to open a file!\n
            Last picked file: ${lpf}\n
            Press Space to change the window bar color!\n
		...
		if (FlxG.keys.justPressed.D)
			lpd = HLNativeWindow.pickDirectory('Pick a directory!');
		if (FlxG.keys.justPressed.F)
			lpf = HLNativeWindow.pickFile('Pick a file!', 'Image, Audio', '*.png;*.jpg;*.jpeg;*.bmp;*.gif;*.mp3;*.ogg;*.wav;*.flac');
		colorBarColorTxt.screenCenter();
